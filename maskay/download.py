...
def SEN2downloadGEE(s2id: str, output: str):
    ...
    # Download S2 image.
    SEN2download(productid, output)
    
    return True

def SEN2download(productid: str=None, output: str):
